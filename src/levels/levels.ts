import { validateKeyframes, type Keyframe } from '../arena/arena';
...
export function validateLevel(def: LevelDef): string[] {
  return validateKeyframes(def.keyframes, ARENA.minGap, ARENA.minInnerRadius, { scoreOutside: !!def.scoreAt });
}
